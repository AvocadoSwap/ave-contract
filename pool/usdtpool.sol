...
contract AVOTokenWrapper {
    ...
    IERC20 public stakeToken = IERC20(0x308f2AB320e0a1384bb090e903e13144B904f9C5);
...
contract AVOUSDTPool is AVOTokenWrapper, IRewardDistributionRecipient {
    IERC20 public avo = IERC20(0xfc53D8d2eDd3EcD2C45C332b12238EE3616aC0AB);
    uint256 public constant DURATION = 1 days;

    uint256 public constant startTime = 1600241430; //utc+8 2020-09-16 16:30:00
